...
@section('title', 'Admin - Create Alternative')
        ...
        <div class="flex-1">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold">Create New Alternative</h1>
                </div>
            </div>
            <p class="text-blue-100 text-lg">
                Add new alternative for the MOORA decision support system
            </p>
        </div>
...
<div class="bg-white rounded-3xl shadow-xl overflow-hidden mb-8">
    ...
    <div class="p-6">        <form action="{{ route('admin.alternatives.store') }}" method="POST" class="space-y-8">
            @csrf
                ...
                <div class="mb-6">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm">Provide values for each evaluation criteria</p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="group">
                                            ...
                                            <div class="relative">
                                                ...
                                                <input type="number" 
                                                       ...
                                                       value="{{ old('criteria_'.$criteria->id) }}" 
                                            ...
                                            <div class="relative">
                                                ...
                                                <select class="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all duration-300 text-gray-700 bg-white appearance-none @error('criteria_'.$criteria->id) border-red-400 focus:border-red-500 focus:ring-red-100 @enderror" 
                                                    ...
                                                    @foreach($criteria->options as $option)
                                                        <option value="{{ $option->id }}" {{ old('criteria_'.$criteria->id) == $option->id ? 'selected' : '' }}>
            ...
            <div class="flex justify-center">
                <div class="flex space-x-4">
                    ...
                    <button type="submit" 
                        ...
                        <i class="fas fa-save mr-2"></i> Create Alternative
                    </button>
                </div>
            </div>
        </form>
