...
@section('title', 'Admin - Create Criteria')
        ...
        <div class="flex-1">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    ...
                    <h1 class="text-2xl md:text-3xl font-bold">Create New Criteria</h1>
                </div>
            </div>
            <p class="text-blue-100 text-lg">
                Add evaluation criteria for the MOORA decision support system
            </p>
        </div>
...
<div class="bg-white rounded-3xl shadow-xl overflow-hidden mb-8">
    ...
    <div class="p-6">
        <form action="{{ route('admin.criterias.store') }}" method="POST" id="criteriaForm">
            @csrf
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <select class="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-300 text-gray-700 bg-white appearance-none @error('type') border-red-400 focus:border-red-500 focus:ring-red-100 @enderror" 
                                ...
                                <option value="benefit" {{ old('type') == 'benefit' ? 'selected' : '' }}>✓ Benefit (Higher is better)</option>
                                <option value="cost" {{ old('type') == 'cost' ? 'selected' : '' }}>✗ Cost (Lower is better)</option>
                            </select>
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <select class="w-full pl-12 pr-4 py-4 rounded-xl border-2 border-gray-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-100 transition-all duration-300 text-gray-700 bg-white appearance-none @error('input_type') border-red-400 focus:border-red-500 focus:ring-red-100 @enderror" 
                                ...
                                <option value="options" {{ old('input_type') == 'options' ? 'selected' : '' }}>📋 Options</option>
                            </select>
                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                <i class="fas fa-chevron-down text-gray-400"></i>
                            </div>
            ...
            <div id="optionsContainer" class="mt-8 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-100 rounded-2xl p-8 shadow-lg transform transition-all duration-500" style="{{ old('input_type') == 'options' ? '' : 'display: none;' }}">
                <div class="mb-6">
